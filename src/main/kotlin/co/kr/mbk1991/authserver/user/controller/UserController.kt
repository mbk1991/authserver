...
import co.kr.mbk1991.authserver.oauth.service.GoogleOAuthService
import co.kr.mbk1991.authserver.oauth.service.KakaoOAuthService
...
class UserController(
    ...
    fun redirectOAuthLoginPage(@PathVariable("provider") provider: String): String {
        return oAuthService.redirectLoginPage(provider)
    }
